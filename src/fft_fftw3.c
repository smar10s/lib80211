...
lib80211_fft_plan *lib80211_fft_plan_create_n(size_t n) {
    ...
    plan->forward = fftwf_plan_dft_1d(n, plan->in, plan->out, FFTW_FORWARD, FFTW_ESTIMATE);
    plan->inverse = fftwf_plan_dft_1d(n, plan->in, plan->out, FFTW_BACKWARD, FFTW_ESTIMATE);
