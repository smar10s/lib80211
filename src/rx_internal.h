 ...
 */
static inline void lib80211_ht_vht_channel_estimate(lib80211_fft_plan *plan,
    ...
    lib80211_fft_forward(plan, ltf_real + LIB80211_NCP, ltf_imag + LIB80211_NCP, Y_real, Y_imag);
 ...
 */
static inline void lib80211_extract_ht_vht_symbol(lib80211_fft_plan *plan,
    ...
    lib80211_fft_forward(plan, sym_real + ncp, sym_imag + ncp, freq_real, freq_imag);
    ...
    if (pilot_state) {
        ...
        if (!pilot_state->initialized) {
            ...
            pilot_state->slope =
                pilot_state->alpha * b + (1.0f - pilot_state->alpha) * pilot_state->slope;
        }
 ...
 * @return 0 on success, -1 on failure
 */
int lib80211_rx_bcc_decode(float *all_soft,
                           size_t total_soft,
                           int n_symbols,
                           int n_dbps,
                           int cr_n,
