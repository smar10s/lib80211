...
static void test_annex_i1_depuncture_decode(void) {
    ...
    size_t n_depunctured = lib80211_depuncture(soft_punctured, soft_depunctured, 1152, 3, 4);
    ...
    if (assert_bits_equal(scr_vec->bits, decoded, n_data_bits, "annex_i1_depuncture_decode")) {
        TEST_PASS();
    } else {
...
static void test_depuncture_roundtrip_34(void) {
    ...
    size_t n_depunctured = lib80211_depuncture(soft_punctured, soft_depunctured, n_punctured, 3, 4);
